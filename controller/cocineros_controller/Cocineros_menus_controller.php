...
<?php 
     ...
     */
    if (isset($_POST["cocinero"]["menus"]["crear"])) {
        if($_POST["cocinero"]["menus"]["crear"]=="Nuevo Menu"){
        $_SESSION["login"]["crear"]=true;   
        }
    }

    if (isset($_POST["cocinero"]["menus"]["crear"])&&$_SESSION["login"]["crear"]) {
        /**-------------------------------------------------crear menus-------------------------------------------------
         * para crear mas menus
         */
        $mensajeCreacion="";
        if (isset($_POST["cocinero"]["menus"]["crear"]["submit"])) {
            /**
             * crea menu
             */
            // $menu->dato1=$_POST["cocinero"]["menus"]["crear"][""];
            // $menu->dato2=$_POST["cocinero"]["menus"]["crear"][""];
            //$menu->crear();
            // $mensajeCreacion="menu con numero: $menu->numero_mesa creada";
                
            $menu->estado=$_POST["cocinero"]["menus"]["crear"]["estado"];
            $menu->descripcion=$_POST["cocinero"]["menus"]["crear"]["descripcion"];
            $menu->crear();
            
            if (isset($_POST["cocinero"]["menus"]["crear"]["plato"])) {
                $platos_recibidos=$_POST["cocinero"]["menus"]["crear"]["plato"];
            ...
            if (isset($_POST["cocinero"]["menus"]["crear"]["bebida"])) {
                $bebidas_recibidas=$_POST["cocinero"]["menus"]["crear"]["bebida"];
            ...
            //include_once '././view/cocineros_view/Administrar_menus_crear_view.php'; 
            /**
            ...
            include_once '././view/cocineros_view/Cocineros_menus_view.php'; 
            ...
            include_once '././view/cocineros_view/Cocineros_menus_crear_view.php'; 
        }
    } elseif (isset($_POST["cocinero"]["menus"]["visualizar"])) {
        /**--------------------------------------------------visualizar-------------------------------------------
         * para visualizar un menu
         */
        
        $id_menu=$_POST["cocinero"]["menus"]["visualizar"]["id"];
        ...
        include_once '././view/cocineros_view/Cocineros_menus_visualizar_view.php'; 
    } else{
        /**-----------------------------------------------pagina principal---------------------------------------------
