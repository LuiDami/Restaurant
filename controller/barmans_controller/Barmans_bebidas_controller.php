...
<?php 
     ...
     */
    if (isset($_POST["barman"]["bebidas"]["crear"])) {
        if($_POST["barman"]["bebidas"]["crear"]=="Nueva Bebida"){
        $_SESSION["login"]["crear"]=true;   
        }
    }

    if (isset($_POST["barman"]["bebidas"]["crear"])&&$_SESSION["login"]["crear"]) {
        /**----------------------------------------------------------crear------------------------------------------
         * para crear mas bebidas
         * envia a Administrar_bebidas_crear_view
         */
        $mensajeCreacion="";
        if (isset($_POST["barman"]["bebidas"]["crear"]["submit"])) {
            /**
             * crea bebida
             */
            ...
            if ($tipo_foto==""||$tipo_foto=="image/jpeg") {
                ...
                $bebida->nombre=$_POST["barman"]["bebidas"]["crear"]["nombre"];
                $bebida->descripcion=$_POST["barman"]["bebidas"]["crear"]["descripcion"];
                $bebida->tipo=$_POST["barman"]["bebidas"]["crear"]["tipo"];
                $bebida->estado=$_POST["barman"]["bebidas"]["crear"]["estado"];
                ...
                include_once '././view/barmans_view/Barmans_bebidas_view.php';

            }else{
                $mensajeCreacion="el formato de imagen no es el correcto";
                include_once '././view/barmans_view/Barmans_bebidas_crear_view.php'; 
            }
        } else {
            # code...
            include_once '././view/barmans_view/Barmans_bebidas_crear_view.php'; 
    ...
    } elseif (isset($_POST["barman"]["bebidas"]["editar"])) {
        /**------------------------------------------------------editar-----------------------------------------------------
         * para editar una bebida
         * obtenemos el id por post
         */
        $id=$_POST["barman"]["bebidas"]["editar"]["id"];

        if (isset($_POST["barman"]["bebidas"]["editar"]["submit"])) {
            /**
            ...
            */
            $datosCambio=$_POST["barman"]["bebidas"]["editar"]["datos"];
            ...
            include_once '././view/barmans_view/Barmans_bebidas_editar_view.php'; 
        }else{
            /**
