...
<body>
    ...
    <nav>
        <form action="./index.php" method="post">
            ...
            <input class="butoom_nav" type="submit" value="Nueva Bebida" name="administrador[bebidas][crear]">
        </form>
    </nav>
                        ...
                        <tbody>
                            <?php
                                ...
                                for($x=0;$x<count($bebidas_array);$x++){
                                    ...
                                    . "<td>"
                                    ."<form action='./index.php' method='post'>"
                                    ."<input type='submit' value='Editar' name='administrador[bebidas][editar]'>"
                                    ."<input type='hidden' value='".$bebidas_array[$x]->id_bebida."' name='administrador[bebidas][editar][id]'>"
                                    ."</form>"
                                    ."</td>"    
                                    . "</tr>";
                                }
