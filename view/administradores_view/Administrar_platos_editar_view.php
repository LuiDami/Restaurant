...
<body>
    ...
    <nav>
        <form action="./index.php" method="post">
            <input class="butoom_nav" type="submit" value="Volver Platos" name="administrador[platos]">
            ...
            <article class="article_crear">
                ...
                <form action="./index.php" method="post" class="form_crear" id="crear" enctype="multipart/form-data">
                    <fieldset  class="formulario">
                        ...
                        <input type="text" name="administrador[platos][editar][datos][nombre]" id="nombre" value="<?php echo $datoActual->nombre; ?>"  maxlength="20" title="Requerido Maximo 20 caracteres" required>
                        <label for="descripcion">Descripcion:</label>
                        <input type="text" name="administrador[platos][editar][datos][descripcion]" id="descripcion" value="<?php echo $datoActual->descripcion; ?>" maxlength="50" title="Maximo 50 caracteres">

                        <label for="tipo">Tipo:</label>
                        <select name="administrador[platos][editar][datos][tipo]" id="tipo">
                        ...
                        <div class="form_radio">
                            <input type="radio" name="administrador[platos][editar][datos][estado]" id="Activado" value="1" 
                            <?php if($datoActual->estado){
                                echo "checked";
                            } ?> >
                            <label for="Activado">Activado:</label>
                            <input type="radio" name="administrador[platos][editar][datos][estado]" id="desactivado" value="0" 
                            <?php if(!$datoActual->estado){
                                echo "checked";
                            } ?>>
                    ...
                    <fieldset class="formulario">
                        ...
                        <textarea id="receta_dasabilitada" name="administrador[platos][editar][datos][receta]" ><?php echo $datoActual->receta; ?></textarea>

                        <legend >Receta</legend>
                        
                        <!-- <input type="text" name="administrador[platos][crear][receta]" id="receta"> -->
                        <!-- <textarea name="administrador[platos][editar][datos][receta]" id="receta_editar" ></textarea> -->

                        <input class="crear_doble" type="submit" name="administrador[platos][editar][submit]" value="Modificar">
                        <input type="hidden" name="administrador[platos][editar][id]" value="<?php echo $id;?>">
                    </fieldset>
                </form>
