...
<body>
    ...
    <nav>
        <form action="./index.php" method="post">
            <input class="butoom_nav" type="submit" value="Volver Bebidas" name="barman[bebidas]">
            <input class="butoom_nav" type="submit" value="Volver Barman" name="barman">
        </form>
    </nav>
            ...
            <article class="article_crear">
                <form action="./index.php" method="post" class=form_crear id="crear" enctype="multipart/form-data">
                    <fieldset class="formulario">
                        ...
                        <input type="text" name="barman[bebidas][editar][datos][nombre]" id="nombre" value="<?php echo $datoActual->nombre; ?>"  maxlength="20" title="Requerido Maximo 20 caracteres" required>
                        <label for="descripcion">Descripcion:</label>
                        <input type="text" name="barman[bebidas][editar][datos][descripcion]" id="descripcion" value="<?php echo $datoActual->descripcion; ?>" maxlength="50" title="Maximo 50 caracteres">

                        <label for="tipo">Tipo (<?php echo $datoActual->tipo; ?>)</label>
                        <select name="barman[bebidas][editar][datos][tipo]" id="tipo">
                        ...
                        <div class="form_radio">
                            <input type="radio" name="barman[bebidas][editar][datos][estado]" id="Activado" value="1" 
                            <?php if($datoActual->estado){
                                echo "checked";
                            } ?>>
                            <label for="Activado">Activado:</label>
                            <input type="radio" name="barman[bebidas][editar][datos][estado]" id="desactivado" value="0" 
                            <?php if(!$datoActual->estado){
                                echo "checked";
                            } ?>>
                    ...
                    <fieldset class="formulario">
                        ...
                        <input type="submit" name="barman[bebidas][editar][submit]" value="Modificar" id="boton_editar_bebida">
                        <input type="hidden" name="barman[bebidas][editar][id]" value="<?php echo $id;?>">
                    </fieldset>
                </form>
