            ...
            <article class="article_crear">
                <form action="./index.php" method="post" class=form_crear id="crear" enctype="multipart/form-data">
                    <fieldset class="formulario">
                        ...
                        <input type="text" name="barman[bebidas][crear][nombre]" id="nombre" maxlength="20" title="Requerido Maximo 20 caracteres" required>
                        <label for="descripcion">Descripcion:</label>
                        <input type="text" name="barman[bebidas][crear][descripcion]" id="descripcion" maxlength="50" title="Maximo 50 caracteres">

                        <label for="tipo">Tipo:</label>
                        <select name="barman[bebidas][crear][tipo]" id="tipo">
                        ...
                        <div class="form_radio">
                            <input type="radio" name="barman[bebidas][crear][estado]" id="Activado" value="1" checked >
                            <label for="Activado">Activado:</label>
                            <input type="radio" name="barman[bebidas][crear][estado]" id="desactivado" value="0">
                            <label for="desactivado">Desactivado:</label>
                        </div>
                        <label for="foto">Foto:</label>
                        <input type="file" name="foto" id="foto" accept="image/jpeg">

                        <input type="submit" name="barman[bebidas][crear][submit]" value="Crear">
                    </fieldset>
                </form>
                <p>
