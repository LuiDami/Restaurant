...
<body>
    ...
    <nav>
        <form action="./index.php" method="post">
            <input class="butoom_nav" type="submit" value="Volver" name="cocinero">
            <input class="butoom_nav" type="submit" value="Nuevo Menu" name="cocinero[menus][crear]">
        </form>
    </nav>
                ...
                <div class="div_datos">
                    <table class="muestra_datos" id="tabla_datos">
                        ...
                        for($x=0;$x<count($menus_array);$x++){
                            ...
                            . "<td>"
                            ."<form action='./index.php' method='post'>"
                            ."<input type='submit' value='Visualizar' name='cocinero[menus][visualizar]'>"
                            ."<input type='hidden' value='".$menus_array[$x]->id_menu."' name='cocinero[menus][visualizar][id]'>"
                            ."</form>"
                            ."</td>"  
                            . "</tr>";
                        }
