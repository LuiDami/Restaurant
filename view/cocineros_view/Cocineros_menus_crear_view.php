...
<body>
    ...
    <nav>
        <form action="./index.php" method="post">
            <input class="butoom_nav" type="submit" value="Volver menus" name="cocinero[menus]">
            <input class="butoom_nav" type="submit" value="Volver Cocineros" name="cocinero">
        </form>
    </nav>
                ...
                <form action="./index.php" method="post" class="form_crear" id="crear">
                        ...
                        <div class="crea_menu_contenido">
                            <table class="muestra_datos" id="tabla_datos">
                                ...
                                for($x=0;$x<count($menus_primeros);$x++){
                                    ...
                                    . "<td>"
                                    ."<input type='checkbox' value='".$menus_primeros[$x]->id_plato."' name='cocinero[menus][crear][plato][".$menus_primeros[$x]->id_plato."]'>"
                                    ."</td>"    
                                    . "</tr>";
                                }
                        ...
                        <div class="crea_menu_contenido">
                            <table class="muestra_datos" id="tabla_datos">
                                ...
                                for($x=0;$x<count($menus_segundos);$x++){
                                    ...
                                    . "<td>"
                                    ."<input type='checkbox' value='".$menus_segundos[$x]->id_plato."' name='cocinero[menus][crear][plato][".$menus_segundos[$x]->id_plato."]'>"
                                    ."</td>"    
                                    . "</tr>";
                                }
                        ...
                        <div class="crea_menu_contenido">
                            <table class="muestra_datos" id="tabla_datos">
                                ...
                                for($x=0;$x<count($menus_postres);$x++){
                                    ...
                                    . "<td>"
                                    ."<input type='checkbox' value='".$menus_postres[$x]->id_plato."' name='cocinero[menus][crear][plato][".$menus_postres[$x]->id_plato."]'>"
                                    ."</td>"    
                                    . "</tr>";
                                }
                                echo $tuplas_postres;
                        ...
                        <div class="crea_menu_contenido">
                            <table class="muestra_datos" id="tabla_datos">
                                ...
                                for($x=0;$x<count($menus_bebidas);$x++){
                                    ...
                                    . "<td>"
                                    ."<input type='checkbox' value='".$menus_bebidas[$x]->id_bebida."' name='cocinero[menus][crear][bebida][".$menus_bebidas[$x]->id_bebida."]'>"
                                    ."</td>"    
                                    . "</tr>";
                                }
                                echo $tuplas_bebidas;
                    ...
                    <div class="crea_menu" id="crear_menu_submit">
                        ...
                        <div class="crea_menu_contenido" >
                            ...
                            <input class="crear_doble" type="text" name="cocinero[menus][crear][descripcion]" id="descripcion" maxlength="20" title="Requerido Maximo 20 caracteres" required>  
                            
                            <div id="radio_menu">
                            <input type="radio" name="cocinero[menus][crear][estado]" id="Activado" value="1" checked >
                            <label for="Activado">Activado:</label>
                            <input type="radio" name="cocinero[menus][crear][estado]" id="desactivado" value="0">
                            <label for="desactivado">Desactivado:</label>
                            </div>

                            <input class="crear_doble" type="submit" name="cocinero[menus][crear][submit]" value="Crear">
                        </div>
                    </div>
